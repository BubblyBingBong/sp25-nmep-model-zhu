...
from .resnet import ResNet18, ResNetDeep,ResNetDeep96x96
...
def build_model(config):
    ...
    elif model_type == 'resnetdeep':
        model = ResNetDeep(num_classes=config.MODEL.NUM_CLASSES)
    elif model_type == 'resnetdeep96x96':
        model = ResNetDeep96x96(num_classes=config.MODEL.NUM_CLASSES)
